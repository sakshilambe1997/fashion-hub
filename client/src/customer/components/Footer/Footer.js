    ...
    <footer>
          ...
          <div class="-mx-4 flex flex-wrap justify-between">
            <div class="px-4 my-4 w-full xl:w-1/5">
              ...
              <p class="text-justify">
                Discover trendy, high-quality clothing for every occasion. Shop
                now for stylish collections, exclusive deals, and unmatched
                comfort. Your fashion journey starts here!
              </p>
            </div>
      ...
      <div class="bg-indigo-700 py-4 text-gray-100">
        <div class="container mx-auto px-4">
          <div class="-mx-4 flex flex-wrap justify-between">
            <div class="px-4 w-2/4 text-center sm:w-auto sm:text-left block mx-auto my-0">
              Fashion Avenue, 3rd Floor, 123 Marine Drive, Mumbai, Maharashtra,
              400020, India.
            </div>
          </div>
        </div>
