      ...
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 my-4 w-full xl:w-1/5">
                ...
                <g fill="none" fill-rule="evenodd">
                  <g transform="translate(0 -75)">
                    ...
                    <text fill="white" font-family="Nunito-Bold, Nunito" font-size="512" font-weight="bold">
                      <tspan x="654" y="518">Fashion Hub</tspan>
                    </text>
                  </g>
                </g>
              </svg>
            ...
            Discover trendy, high-quality clothing for every occasion. Shop now for stylish collections, exclusive deals, and unmatched comfort. Your fashion journey starts here!
            </p>
          </div>
